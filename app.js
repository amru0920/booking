...
/* ─────────────────────────────────────────────────────────────
   ...
   ───────────────────────────────────────────────────────────── */
/* ---------------------------------------------------------
   [AUTH] HIDDEN ADMIN — Ketuk logo 5x untuk buka admin login
   --------------------------------------------------------- */
let _adminTap = 0, _adminTapTimer = null;
function adminTapCount() {
  _adminTap++;
  // Reset counter lepas 3 saat kalau tak cukup 5 ketukan
  clearTimeout(_adminTapTimer);
  _adminTapTimer = setTimeout(() => { _adminTap = 0; }, 3000);
  if (_adminTap >= 5) {
    _adminTap = 0;
    showAdminLogin();
    document.getElementById('btnShowAdmin').style.display = 'block';
  }
}
